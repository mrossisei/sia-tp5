...
\begin{frame}{Estudio 1 --- MSE por dim latente}
  \centering
  {\scriptsize\color{gray} Varia: dim latente $\in\{2,8,16\}$ (resto fijo: 2 seeds [42,7], 1000 epoch).}
  \includegraphics[width=0.62\linewidth]{exp_latent_dim_mse.png}
  \vfill
  {\footnotesize \textbf{8D} mejora claramente (MSE$=1{.}20\pm0{.}04$);
   \textbf{2D} sacrifica detalle (MSE$=3{.}94\pm0{.}14$);
...
\begin{frame}{Estudio 3 --- KL warmup: parametros}
  \begin{columns}[T]
    \begin{column}{0.55\textwidth}
      \begin{table}\small
        \begin{tabular}{ll}
...
\begin{frame}{Estudio 3 --- efecto del KL warmup}
  \centering
